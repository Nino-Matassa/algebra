...
public class Symbol {
	...
	public static final String mu = "μ";
	public static final String Nu = "N";
	public static final String nu = "ν";
	public static final String Ki = "Ξ";
	public static final String ki = "ξ";
	...
	public static final String sqRoot = "√";
	public static final String infinity = "∞";
	// Symbols
	public static final String momentum = "p";
	public static final String mass = "m";
	public static final String velocity = "v";
	public static final String displacement = "x";
	//
	public static final String angle = Theta;
